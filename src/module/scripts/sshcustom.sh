...
start_daemon() {
  ...
  # Apply TCP buffer tuning BEFORE starting the daemon so the SSH carrier
  # socket itself benefits from the larger windows. This mirrors vpnchain's
  # ssh.service calling ssh.tool speed_boost before launching sshcustomd.
